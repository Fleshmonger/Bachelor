...
%==================================================================================================
\def\thesisauthor{Carsten M. R. Nielsen}					%Author
...
\include{ProjectProcess}
\include{Starcraft}
\include{RelatedWorks}
\include{Design}
\include{Resources}											%Chapter 3
\include{Production}										%Chapter 4
\include{Information}										%Chapter 5
\include{Combat}											%Chapter 6
\include{Strategy}											%Chapter 7
\include{Summary}
\include{Results}
\include{Conclusion}
%\appendix
